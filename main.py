...
def creditos():
	...
	while not sair:
		...
		surface_texto, rect_texto = text_objects("Programador: \nGabriel Santos\nAriane Goes", fonte, BRANCO)
		rect_texto.center = ((LARGURA / 2), ALTURA / 3)
		display.blit(surface_texto, rect_texto)

		surface_texto, rect_texto = text_objects("Disciplina: Computação Gráfica e Realidade Virtual /Professor Joberto Sergio", fonte, BRANCO)
		rect_texto.center = ((LARGURA / 2), ALTURA / 2.7)
		display.blit(surface_texto, rect_texto)

		surface_texto, rect_texto = text_objects("Versao Python: 3.11.x", fonte, VERMELHO_CLARO)
		rect_texto.center = ((LARGURA / 2), ALTURA / 1.5)
		display.blit(surface_texto, rect_texto)

		surface_texto, rect_texto = text_objects("Versao Pygame: 2.5.2", fonte, VERMELHO_CLARO)
